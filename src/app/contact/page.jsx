                        ...
                        <div>
                            ...
                            <div className="relative mt-2">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full pl-[4.5rem] pr-3 py-2 appearance-none bg-transparent outline-none border focus:border-gray-300 shadow-sm rounded-lg"
                                />
                            </div>
                        </div>
                        <div>
                            ...
                            <textarea required className="w-full mt-2 h-36 px-3 py-2 resize-none appearance-none bg-transparent outline-none border focus:border-gray-300 shadow-sm rounded-lg"></textarea>
                        </div>
                        <button
